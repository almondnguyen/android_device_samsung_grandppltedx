...
//    AP_CFG_CUSTOM_FILE_CUSTOM2_LID,
    ...
    AP_CFG_CUSTOM_FILE_CUSTOM_FMT_LID,   //71
    AP_CFG_CUSTOM_FILE_CUSTOM_FMT_1_LID,  //72
    //hct:liuyang	
    AP_CFG_CUSTOM_FILE_CUSTOM1_LID,
    //liuyang add begin @20150918
    AP_CFG_CUSTOM_FILE_CUSTOM_SNUM_LID,  //74
    //liuyang add end @20150918
...
//<<hct:liuyang add @20130105
#define AP_CFG_CUSTOM_FILE_CUSTOM_FMT_LID_VERNO	       "000"
#define AP_CFG_CUSTOM_FILE_CUSTOM_FMT_1_LID_VERNO      "000"
#define AP_CFG_CUSTOM_FILE_CUSTOM_SNUM_LID_VERNO      "000"
//hct:liuyang
